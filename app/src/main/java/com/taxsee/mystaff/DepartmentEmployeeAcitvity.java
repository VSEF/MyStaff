...
public class DepartmentEmployeeAcitvity extends AppCompatActivity {
        ...
        protected void onCreate(final Bundle savedInstanceState) {
            ...
            for(DepartmentEmployee employee:departmentEmployeeList){
                if(employee.getDep_id()==Integer.valueOf(empl_id)) {
                    arrEmplDep2.add("ID: " + employee.getEmp_id() + ", Name: " + employee.getEmp_name());
                }
            }
